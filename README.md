<div align="center">
  ...
  <h2>42 EVALUATION SYSTEM</h2>
    ...
    <img src="https://img.shields.io/github/last-commit/emre-mr246/42_ring0_libft?style=for-the-badge"/>
...
**THE NORM**
The norm rules are a set of guidelines similar to SOLID principles. These rules help make our projects more organized and readable. At Ecole 42, even a single norm violation can result in the project receiving a failing grade.
...
The 42 Moulinette is an automated grading tool used at Ecole 42 to evaluate student projects. This powerful tool is designed to ensure that all submissions meet the school's rigorous standards. Here's an overview of its key features and benefits:

1. Automated Testing: The Moulinette runs a series of predefined tests on your code to check for correctness, efficiency, and adherence to project specifications. It ensures that your program behaves as expected under various conditions.
2. Norm Compliance: The Moulinette verifies that your code follows the Ecole 42 norm rules, which are akin to modern SOLID principles. These rules help make your code more readable, maintainable, and efficient. A single norm violation can result in a failing grade, emphasizing the importance of clean coding practices.
 3. Memory Leak Detection: During the evaluation, the Moulinette checks for memory leaks and other potential issues that could affect the stability and performance of your program. Ensuring that your code is free of leaks is crucial for creating reliable and efficient software.
  4. Comprehensive Feedback: After running its tests, the Moulinette provides detailed feedback on your submission. This includes information on any errors or issues detected, as well as suggestions for improvement. This feedback is invaluable for learning and improving your coding skills.
